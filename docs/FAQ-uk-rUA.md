...
* Змінити ім'я облікового запису: Параметри, Початок, 1. Додати облікові записи, налаштування вручну та додаткові параметри, торкніться облікових записів
* Change the swipe left/right target: Settings, tab page Behavior, Set swipe actions
* Змінити пароль: Параметри, Початок, 1. Додати облікові записи, налаштування вручну та додаткові параметри, торкніться облікових записів, змініть пароль
* Установити підпис: Параметри, Початок, 1. Додати облікові записи, налаштування вручну та додаткові параметри, натисніть "Особисті дані", виберіть обліковий запис, натисніть "Редагувати підпис".
...
* Export/import settings: Settings, navigation/hamburger menu</ul>
