...
* [103) Как я могу записывать звук?](#user-content-faq103)
...
* [(138) Можно добавить календарь / управление контактами / синхронизацию?](#user-content-faq138)
...
* Необязательно: * прочтите свои контакты * (READ_CONTACTS): для автозаполнения адресов и отображения фотографий
