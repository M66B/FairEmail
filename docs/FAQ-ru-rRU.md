...
Если у вас есть вопрос, пожалуйста, сначала просмотрите часто задаваемые вопросы. Внизу вы можете выяснить, как задавать другие вопросы, запрашивать новые возможности и сообщать об ошибках.

## Оглавление

* [Авторизация учетных записей](https://github.com/M66B/FairEmail/blob/master/FAQ.md#user-content-authorizing-accounts)
...
* [Поддержка](https://github.com/M66B/FairEmail/blob/master/FAQ.md#user-content-support)
...
Ошибка *... Authentication failed ... Account not found ...* means that a previously authorized Gmail account was removed from the device.
