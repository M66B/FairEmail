...
The errors *... Неуспела провера идентитета ... No token ...* means that the Android account manager failed to refresh the authorization of a Gmail account.
...
![Неучитана слика](https://github.com/M66B/FairEmail/blob/master/images/baseline_broken_image_black_48dp.png)
