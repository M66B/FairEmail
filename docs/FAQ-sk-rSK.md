...
The error *... Overenie zlyhalo ... Account not found ...* means that a previously authorized Gmail account was removed from the device.

The errors *... Overenie zlyhalo ... No token ...* means that the Android account manager failed to refresh the authorization of a Gmail account.
...
![Porušený obrázok](https://github.com/M66B/FairEmail/blob/master/images/baseline_broken_image_black_48dp.png)
...
* Relatívny čas (prijaté) v rozmedzí
...
* *Použiť štýl oznámení správ systému Android*
