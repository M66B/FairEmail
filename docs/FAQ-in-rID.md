...
Menonaktifkan optimisasi baterai (pengaturan langkah 3) akan mengurangi kesempakan Android yang akan memberhentikan layanan singkronisasi.
...
The red/orange stripe at the left side of the header means that the DKIM, SPF or DMARC authentication failed. Lihat juga [FAQ ini](#user-content-faq92).
...
* *Gunakan format notifikasi 'Gaya pesan' Android*
...
<h2><a name="get-support"></a>Ambil bantuan</h2>

FairEmail is supported on Android smartphones and tablets and ChromeOS only.

Hanya versi Play store terbaru dan rilis GitHub terbaru yang terdukung. The F-Droid build is supported only if the version number is the same as the version number of the latest GitHub release. Hal ini juga berarti tidak dapat menurunkan peringkat.
...
Fitur yang tidak memenuhi persyaratan ini kemungkinan besar akan ditolak. This is also to keep maintenance and support in the long term feasible.
...
Hak cipta &copy; 2018-2021 Marcel Bokhorst.
