...
如果你有疑問，請先查閱以下被頻繁問起的問題。 在這底下，你可以找到關於如何提問，請求功能以及反饋bugs的地方。

## 目錄

* [認證帳號中](https://github.com/M66B/FairEmail/blob/master/FAQ.md#user-content-authorizing-accounts)
* [如何 ...？](https://github.com/M66B/FairEmail/blob/master/FAQ.md#user-content-howto)
* [已知的問題](https://github.com/M66B/FairEmail/blob/master/FAQ.md#user-content-known-problems)
...
If the quick setup wizard fails, you'll need to manually set up an account (to receive email) and an identity (to send email). 為此，您需要使用IMAP和SMTP服務器地址和端口號，而無論使用SSL / TLS還是STARTTLS 以及您的用戶名（大多數但並非總是您的電子郵件地址）和密碼。
