...
* ~~A [bug in AndroidX ROOM](https://issuetracker.google.com/issues/138441698) causes sometimes a crash with "*... Exception while computing database live data ... Couldn't read row ...*". 回避策が追加されました。~~
...
* ~~A [bug in AndroidX](https://issuetracker.google.com/issues/64729576) makes it hard to grap the fast scroller. 回避策が追加されました。~~
...
<h2><a name="frequently-requested-features"></a>よくリクエストされる機能</h2>
...
![壊れた画像](https://github.com/M66B/FairEmail/blob/master/images/baseline_broken_image_black_48dp.png)
...
<h2><a name="get-support"></a>サポートについて</h2>
