...
* [Autorizar contas](#user-content-authorizing-accounts)
* [Como...?](#user-content-howto)
* [Problemas conhecidos](#user-content-known-problems)
* [Funcionalidades planeadas](#user-content-planned-features)
* [Funcionalidades solicitadas com frequência](#user-content-frequently-requested-features)
* [Perguntas Mais Frequentes](#user-content-frequently-asked-questions)
* [Obter Ajuda](#user-content-get-support)

<h2><a name="authorizing-accounts"></a>Autorizar contas</h2>
...
<h2><a name="planned-features"></a>Funcionalidades planeadas</h2>
...
<h2><a name="frequently-requested-features"></a>Funcionalidades solicitadas com frequência</h2>
...
<h2><a name="frequently-asked-questions"></a>Perguntas Mais Frequentes</h2>
...
Operations are processed only when there is a connection to the email server or when manually synchronizing. Ver também [esta FAQ](#user-content-faq16).
...
The preview of the message text cannot be shown if the message body has not been downloaded yet. Ver também [esta FAQ](#user-content-faq15).
...
Ver também [esta FAQ](#user-content-faq4).
...
<a name="faq45"></a>
**(45) How can I fix 'This key is not available. Para utiliza-lo, deverá importá-lo como um dos seus!' ?**
...
The red/orange stripe at the left side of the header means that the DKIM, SPF or DMARC authentication failed. Ver também [esta FAQ](#user-content-faq92).
...
<h2><a name="get-support"></a>Obter Ajuda</h2>
